...
public class PitchFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_pitch, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.pitch_recycler_view);
        ...
        mAdapter = new PitchAdapter(sp_array,getContext());
        ((PitchAdapter) mAdapter).setListener(createlistner());
        recyclerView.setAdapter(mAdapter);
        LinearLayoutManager mlayoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(mlayoutManager);
        SharedPreferences pref= DataStore.getSharedPreferences(getContext());
        lastPosition=pref.getInt(DataStore.pitch_position,0);
    ...
    private PitchAdapter.Listener createlistner(){
        return new PitchAdapter.Listener() {
            @Override
            public void transition(int sp10) {
                ...
                editor.putInt(DataStore.pitch_position,lastPosition);
                editor.apply();
            ...
            public void changePitch(float speed) {
                MediaControllerCompat.getMediaController(getActivity()).getTransportControls().setPlaybackSpeed(speed+1000);
            }
